      ...
      <section className="py-16 px-6 max-w-4xl mx-auto">
        <FadeIn>
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <a href="https://www.youtube.com/@DANCHOSAMTV" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-5 py-3 rounded-full border border-[var(--color-beige-dark)] bg-white hover:shadow-sm transition-shadow text-[var(--color-text-muted)] text-sm">
              <span>▶</span> 유튜브
            </a>
