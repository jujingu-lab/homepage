    ...
    reviews: [
      {
        ...
        role: "한의사 · 작가 / hani***",
        tag: "이키가이 브랜딩 챌린지",
        title: "이제는 나를 말할 수 있게 되었습니다 — 쉼을 건네는 이름, hani***",
      ...
      },
      {
        ...
        role: "이키가이 챌린지 참여자",
        tag: "이키가이 챌린지",
        title: "4주 동안 나에 대해 깊이 들여다본 보람찬 시간",
        quote: "4주 동안 진지하게 생각하고, 나에 대해 생각을 많이 해보는 시간이었습니다.",
        content: [
          "4주 동안 보람찬 시간이었습니다. 매일 조금씩 나에 대해 생각해보는 시간을 가졌습니다.",
          "때로는 질문에 대한 대답을 내 자신 깊숙한 곳에서 찾느라 시간이 걸리기도 했고, 며칠은 질문의 무게감에 고민하기도 하고 부담감에 도망치기도 했습니다.",
          "하지만 4주 동안 진지하게 생각하고 나에 대해 생각을 많이 해보는 시간이었습니다. 감사합니다. 꾸벅!",
        ],
        images: [
